...
# Solution no 1
oneL, twoL = input('enter the no of bottles you have of 1L and more than 1L: ').split()
oneL_cash = int(oneL) * 0.25
twoL_cash = int(twoL) * 0.10
print('you have', oneL, '1L bottles and your total deposit is $', round(oneL_cash, 2),
      '\nyou have', twoL, ' 2L bottles and your total deposit is $', round(twoL_cash, 2),
      '\nyour total deposit is', oneL_cash + twoL_cash)

# solution no 2

size = float(input('enter the size of your bottles: '))
num = int(input('enter the no of bottles: '))
total1 = num * 0.10
total2 = num * 0.25
if size <= 0.5:
    print("your total deposit is $", total1)
elif size > 0.5:
    print('your total deposit is $', total2)
else:
...
print("your total check  is ", round(total_bill, 2), '\nincluding 10% meal tax which accounts for ',
      round(meal_tax, 2),
      '\nand tip of', round(tip, 2), 'rupees')
...
balance = int(input('enter the current balance of your account'))
interest = (4 / 100) * balance
one_year = balance + interest
two_year = balance + (interest * 2)
three_year = balance + (interest * 3)
print('your total balance after year is ', round(one_year, 2),
      "\nyour total balance after 2 years is", round(two_year, 2),
      "\nyour total balance after 3 years is ", round(three_year, 2))
...
print('distance bw two points is', distance)
...
units_of_electricity_in_cup_boiling = 24
cost_per_unit = 9
bill = int(units_of_electricity_in_cup_boiling) * int(cost_per_unit)
...
print('the area of your triangle is:', formula)
...
median = int(som) - int(min(n)) - int(max(n))
print(median)
...
print('the price of your bread is:', price, "\nyou got", percentage_off, "discount on your bread, "
                                                                         "\nnow your total price after discount is:",
      round(total_bill, 2))
